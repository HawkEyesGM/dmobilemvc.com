...
<html lang="en">
<head>
  <title>Admin autorization</title>
  <meta charset="utf-8">
...
<body id="reg_body">	
	<div class="container container-reg">
		...
		<form class="well form-horizontal" action="/admin/user/auth" method="POST"  id="contact_form" enctype="multipart/form-data">
			<fieldset>
				<h1 class="reg">Форма авторизации администратора</h1><br>				
				...
				<div class="form-group">
					...
					<div class="col-md-4">						
						<input type="submit" class="btn btn-danger" name="auth" value="Авторизироваться">
					</div>
				</div>
